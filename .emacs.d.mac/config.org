      ...
      (let* ((package--builtins nil)
             (packages
              '(
                ...
                golden-ratio ace-window paredit projectile counsel-projectile diminish rainbow-delimiters undo-tree
...
**** FONTS
     ...
     TODO ATTEMPTED FIX ONCE AGAIN. This is in my resources file, too.

     #+BEGIN_SRC emacs-lisp
       ;; (add-to-list 'default-frame-alist '(font . "Fira Code-12"))
       ;; (add-to-list 'default-frame-alist '(font . "-CTDB-Fira Code-normal-normal-normal-*-*-*-*-*-m-0-iso10646-1"))
...
**** undo tree
     #+BEGIN_SRC emacs-lisp
       ...
       ;; elpa isn't working, so i can't dl anything from it lol
...
*** TODO org
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (setq org-journal-dir "/Users/eg046613/org/journal")
      ...
      (defun generic-org-minor-modes ()
        ...
        (org-bullets-mode 1)
        (org-cdlatex-mode 1)
        ;; I am pretty sure this adds a delay to loading any org file
        ;; and some generally laggy behavior for some certain actions
        ;; so goodbye for now.
        ;;(emojify-mode 1)
        (auto-fill-mode 1))
...
*** HL7
    #+BEGIN_SRC emacs-lisp
      (autoload 'highlight-chars "~/.emacs.d/highlight-chars.el" "minor mode for highlighting chars." t nil)
      (autoload 'hl7-mode "~/.emacs.d/hl7-mode/hl7-mode.el" "Major mode for editing HL7v2 messages." t nil)
