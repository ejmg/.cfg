...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(dark-mint-theme)
...
you should place your code here."
   ...
   (global-company-mode)
   (setq-default fill-column 80);;sets column at which text wraps to 80
