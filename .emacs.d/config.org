...
*** packages
      ...
      (let* ((package--builtins nil)
             (packages
              '(
                ...
                pandoc-mode lorem-ipsum quelpa-use-package symon sx alarm-clock
                ...
                ;; org
                org-bullets org-pomodoro org-download htmlize org-journal secretaria org-download
    ...
    #+END_SRC
**** local packages
     we'll put them in a directory called =custom/= under =.emacs.d/=
     #+BEGIN_SRC emacs-lisp
...
**** theme, styling, and transparency
     #+BEGIN_SRC emacs-lisp
       ...
       (with-eval-after-load "minimal-light-theme"
...
**** TODO org
     ...
     #+BEGIN_SRC emacs-lisp
       ...
       (defun generic-org-minor-modes ()
         ...
         ;; there's a possibility that emojify-mode is behind some laggy behavior.
         (emojify-mode 1)
...
**** TODO tex
     ...
     Here's an attempt at a config that allows bibtex
...
*** TODO leader key
    ...
    For global, I'm going to use =M-m=, which is going to be reserved for those things that don't
    change often but I use everywhere.... I think.
    #+BEGIN_SRC emacs-lisp
...
*** TODO org mode bindings
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (which-key-add-key-based-replacements "<XF86Launch2>" "agenda")
    #+END_SRC
...
*** TODO spotify
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (spotify-leader
       "c" 'spotify-remote-mode
       "SPC" 'spotify-toggle-play
      ;; "M-l r" 'spotify-refresh-mode-line
       "M-l s" 'spotify-set-mode-line-refresh
       "M-l d" 'spotify-disable-mode-line
       "M-p s" 'spotify-playlist-select)
    #+END_SRC
*** TODO sx
    #+BEGIN_SRC emacs-lisp
      (launcher-map
       "ss" 'sx-search
       "st" 'sx-tab-all-questions)
    #+END_SRC
*** rust keybindings
...
*** TODO webprogramming
    #+BEGIN_SRC emacs-lisp
      ...
      ;; Useful when I was doing python. not relevant right now.
