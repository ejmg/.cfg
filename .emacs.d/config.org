      ...
      (let* ((package--builtins nil)
             (packages
              '(
                ...
                pandoc-mode lorem-ipsum quelpa-use-package
...
*** TODO utility key bindings
    ...
    wanted w/o polluting keyspace.

**** TODO projectile
     #+BEGIN_SRC emacs-lisp
       (g-leader
         "M-p s" 'counsel-projectile-switch-project
         "M-p p" 'counsel-projectile
...
*** rust keybindings
    ...
    #+BEGIN_SRC emacs-lisp
      (local-leader
        ...
        "C-t t" 'cargo-process-current-test
