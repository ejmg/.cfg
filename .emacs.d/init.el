...
(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("~/org/cmr.org" "~/org/inbox.org" "~/org/tasks.org")))
 ...
 '(safe-local-variable-values
   (quote
    ((major-mode . shell-script-mode)
     (major-mode . sh-mode)
     (company-clang-arguments "-I/home/spook/code/umkc/cs303_hw3/lib/")
     (company-clang-arguments "-I/home/spook/code/umkc/cs303/ex/stack_applications/")))))
;; (custom-set-faces
;;  ;; custom-set-faces was added by Custom.
;;  ;; If you edit it by hand, you could mess it up, so be careful.
;;  ;; Your init file should contain only one such instance.
;;  ;; If there is more than one, they won't work right.
;;  '(org-block-begin-line ((t (:background "grey98" :foreground "gray80" :weight bold))))
;;  '(org-block-end-line ((t (:foreground "gray70")))))
(provide 'init)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(tooltip ((t (:background "gray90" :height 0.8 :family "Sans Serif")))))
